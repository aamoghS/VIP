...
const QUESTIONS: Question[] = [
  ...
  // ── Folding Clothes (Variables, Conditionals, Loops) ───────────────────────
  {
    ...
    topic: "variables",
    type: "multiple-choice",
    question: "You are folding clothes and want to track how many items you've folded. Which variable name makes the most sense?",
    options: ["folded_count", "x", "stuff", "number"],
    currentAnswer: "folded_count",
    reasoning: "A descriptive variable name like 'folded_count' clearly shows what it stores.",
  },
  {
    id: 101,
    topic: "logic",
    type: "multiple-choice",
    question: "You are folding clothes. If the item is 'pants' or 'shirts', you fold it. If it's 'socks', you find a match. What does this represent in code?",
    options: ["A loop", "An if-else statement", "A function", "A variable"],
    currentAnswer: "An if-else statement",
    reasoning: "This is a conditional! You're making a decision based on what type of item you have.",
  },
  {
    id: 102,
    topic: "loops",
    type: "multiple-choice",
    question: "You have a pile of 15 clothes to fold. You want to fold each one until the pile is empty. What loop would work best?",
    options: ["for item in clothes_pile:", "while True:", "if clothes_pile:", "print(folded)"],
    currentAnswer: "for item in clothes_pile:",
    reasoning: "A 'for' loop is perfect here! It goes through each item one by one.",
  },
  {
    id: 103,
    topic: "logic",
    type: "multiple-choice",
    question: "When folding socks, you need to check: if socks don't have a match, set them aside. What condition would you use?",
    options: ["if sock.has_match == False:", "if sock.color > 5:", "if sock == sock:", "print(sock)"],
    currentAnswer: "if sock.has_match == False:",
    reasoning: "You need to check if the sock doesn't have a match.",
  },
  ...
  // ── Fruits (Sorting, Filtering, Grouping) ─────────────────────────────────
  {
    ...
    topic: "algorithms",
    type: "multiple-choice",
    question: "You are sorting fruits by type: Oranges, Apples, Strawberries. What algorithm concept is this?",
    options: ["Filtering", "Sorting", "Looping", "Variables"],
    currentAnswer: "Sorting",
    reasoning: "Sorting means putting things in a specific order!",
  },
  {
    id: 111,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to separate normal fruits from rotten ones and throw away the rotten ones. What are you doing?",
    options: ["Sorting", "Filtering", "Looping", "Counting"],
    currentAnswer: "Filtering",
    reasoning: "Filtering means keeping only the items that meet a certain condition.",
  },
  {
    id: 112,
    topic: "logic",
    type: "multiple-choice",
    question: "To check if a fruit is rotten, you write: if fruit.is_rotten == True: throw_away(). What type of statement is this?",
    options: ["Loop", "Variable", "Conditional", "Function call"],
    currentAnswer: "Conditional",
    reasoning: "This is a conditional statement!",
  },
  {
    id: 113,
    topic: "loops",
    type: "multiple-choice",
    question: "You have a list of fruits and need to check each one to see if it's rotten. What do you use?",
    options: ["A variable", "A loop", "An if statement only", "A print statement"],
    currentAnswer: "A loop",
    reasoning: "You need a loop to go through each fruit in your list.",
  },
  ...
  // ── Math (Expressions, Ratios, Fractions) ─────────────────────────────────
  {
    ...
    topic: "variables",
    type: "multiple-choice",
    question: "You need to evaluate 3x + 5 when x = 4. What is the first step?",
    options: ["Replace x with 4", "Print the answer", "Create a variable", "Start a loop"],
    currentAnswer: "Replace x with 4",
    reasoning: "To evaluate an expression with a variable, you substitute the variable with its given value!",
  },
  {
    id: 121,
    topic: "logic",
    type: "multiple-choice",
    question: "You are checking if a snack pack follows a 2 chips : 1 juice ratio. If it has 4 chips and 2 juice, is it correct?",
    options: ["Yes, because 4/2 = 2", "No, because 2 + 1 = 3", "Yes, because there are more chips", "No, because 4 > 2"],
    currentAnswer: "Yes, because 4/2 = 2",
    reasoning: "The ratio 2:1 means 2 chips for every 1 juice.",
  },
  {
    id: 122,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to group correct vs incorrect math answers. What data structure would work best?",
    options: ["A single number", "Two lists (correct_answers, incorrect_answers)", "A loop", "A function"],
    currentAnswer: "Two lists (correct_answers, incorrect_answers)",
    reasoning: "Using two separate lists lets you group and organize the answers.",
  },
  {
    id: 123,
    topic: "logic",
    type: "multiple-choice",
    question: "To remove incorrect answers, you write: if answer.is_correct == False: remove(answer). What does this demonstrate?",
    options: ["A loop", "A conditional filter", "A variable", "A function definition"],
    currentAnswer: "A conditional filter",
    reasoning: "This is filtering! You're using a condition to decide which items to keep.",
  },
  ...
  // ── Science - Water Cycle ─────────────────────────────────────────────────
  {
    ...
    topic: "logic",
    type: "multiple-choice",
    question: "Given temperature = 30°F, what happens to water? (Freezing point is 32°F)",
    options: ["It freezes", "It boils", "It stays liquid", "It evaporates"],
    currentAnswer: "It freezes",
    reasoning: "Water freezes at 32°F or below. Since 30 < 32, the water will freeze!",
  },
  {
    id: 131,
    topic: "loops",
    type: "multiple-choice",
    question: "You have a list of 7 days with temperatures. You need to find all days above 80°F. What do you use?",
    options: ["A variable", "A loop with a condition", "An if statement only", "A function"],
    currentAnswer: "A loop with a condition",
    reasoning: "You need a loop to check each day's temperature AND a condition to filter.",
  },
  {
    id: 132,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to separate rainy days from sunny days. What algorithm concept is this?",
    options: ["Sorting", "Filtering", "Looping", "Variables"],
    currentAnswer: "Filtering",
    reasoning: "You're keeping days that match certain conditions - that's filtering!",
  },
  {
    id: 133,
    topic: "algorithms",
    type: "multiple-choice",
    question: "To find the hottest day, you keep track of the highest temperature as you check each day. What is this called?",
    options: ["Finding the maximum", "Sorting", "Counting", "Filtering"],
    currentAnswer: "Finding the maximum",
    reasoning: "Finding the maximum is a common algorithm!",
  },
  ...
  // ── Science - Rock Types & Cells ──────────────────────────────────────────
  {
    ...
    topic: "logic",
    type: "multiple-choice",
    question: "You are sorting rocks by hardness. If rock.hardness > 7, it's 'hard'. What type of statement is this?",
    options: ["Loop", "Variable", "Conditional", "Function"],
    currentAnswer: "Conditional",
    reasoning: "This checks a condition and categorizes the rock.",
  },
  {
    id: 141,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to separate plant cells from animal cells. What do you check for?",
  ...
  },
  {
    ...
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to remove cells with missing parts. What algorithm concept is this?",
    options: ["Sorting", "Filtering", "Looping", "Variables"],
    currentAnswer: "Filtering",
    reasoning: "You're keeping only complete cells and removing incomplete ones.",
  },
  {
    id: 143,
    topic: "logic",
    type: "multiple-choice",
    question: "To group cells by organelles, you write: if cell.has_mitochondria: add_to_group('mito'). What does this demonstrate?",
    options: ["A loop", "A conditional classification", "A variable", "A function definition"],
    currentAnswer: "A conditional classification",
    reasoning: "You're using a condition to classify items into groups.",
  },
  ...
  // ── Science - Organisms & Food Chains ─────────────────────────────────────
  {
    ...
    topic: "logic",
    type: "multiple-choice",
    question: "You are grouping organisms: producers, consumers, decomposers. What determines which group an organism belongs to?",
    options: ["Size", "How it gets energy", "Color", "Location"],
    currentAnswer: "How it gets energy",
    reasoning: "Organisms are classified by their role in the food chain!",
  },
  {
    id: 151,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to remove misplaced organisms from a food chain. What are you doing?",
    options: ["Sorting", "Filtering", "Looping", "Counting"],
    currentAnswer: "Filtering",
    reasoning: "You're removing items that don't belong - that's filtering!",
  },
  {
    id: 152,
    topic: "algorithms",
    type: "multiple-choice",
    question: "To build a food chain, you need to order organisms from energy source to top predator. What is this called?",
    options: ["Filtering", "Sorting", "Looping", "Variables"],
    currentAnswer: "Sorting",
    reasoning: "Putting things in a specific order based on a rule is sorting!",
  },
  ...
  // ── ELA - Sentence Structure & Grammar ────────────────────────────────────
  {
    ...
    topic: "logic",
    type: "multiple-choice",
    question: "You are editing an essay and check: if sentence.has_spelling_error: mark_for_fix(). What is this?",
    options: ["A loop", "A conditional check", "A variable", "A function definition"],
    currentAnswer: "A conditional check",
    reasoning: "You're checking each sentence for a specific condition.",
  },
  {
    id: 161,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to remove repeated sentences from an essay. What algorithm concept is this?",
    options: ["Sorting", "Filtering", "Looping", "Variables"],
    currentAnswer: "Filtering",
    reasoning: "You're keeping only unique sentences and removing duplicates.",
  },
  {
    id: 162,
    topic: "logic",
    type: "multiple-choice",
    question: "To check if each paragraph has a topic sentence, you write: if not para.has_topic_sentence: flag_paragraph(). What does this do?",
    options: ["Marks paragraphs missing a topic sentence", "Adds topic sentences", "Removes paragraphs", "Counts paragraphs"],
    currentAnswer: "Marks paragraphs missing a topic sentence",
    reasoning: "This conditional checks for a missing topic sentence.",
  },
  {
    id: 163,
    topic: "algorithms",
    type: "multiple-choice",
    question: "You need to identify claims in an article and match them with supporting evidence. What data structure helps?",
    options: ["A single variable", "A dictionary (claim: evidence)", "A loop", "A function"],
    currentAnswer: "A dictionary (claim: evidence)",
    reasoning: "A dictionary lets you store key-value pairs.",
  },
