...
const QUESTIONS: Question[] = [
  ...
  // ── ELA - Stories & Arguments ─────────────────────────────────────────────
  {
    ...
    topic: "algorithms",
    type: "multiple-choice",
    question: "Events out of order: [Hero falls, Hero trains, Hero wins, Hero is born]. Arrange chronologically. What's the algorithm?",
    options: ["Filtering", "Sorting by time", "Searching", "Counting"],
    currentAnswer: "Sorting by time",
    reasoning: "Ordering events by when they happened - sorting by temporal criteria!",
  },
  {
    id: 171,
    topic: "algorithms",
    type: "multiple-choice",
    question: "Story about a dragon but found event about cooking pasta. Doesn't fit. What do you do?",
    options: ["Keep it anyway", "Remove it (filter)", "Sort it first", "Count it"],
    currentAnswer: "Remove it (filter)",
    reasoning: "Filtering out events that don't belong to the main story - keeping only relevant content!",
  },
  {
    id: 172,
    topic: "logic",
    type: "multiple-choice",
    question: "Code: 'if arg1.strength > arg2.strength: rank_ahead(arg1, arg2)'. What does this comparison determine?",
    options: ["Which is longer", "Which comes first in sorted order", "Which has more words", "Which is older"],
    currentAnswer: "Which comes first in sorted order",
    reasoning: "Comparing strength determines relative ordering - stronger one gets ranked higher!",
  },
  {
    id: 173,
    topic: "logic",
    type: "multiple-choice",
    question: "Code: 'if not arg.has_evidence: mark_weak(arg)'. Argument has 3 pieces of evidence. What happens?",
    options: ["It's marked weak", "It's NOT marked weak", "Error", "Deleted"],
    currentAnswer: "It's NOT marked weak",
    reasoning: "'not arg.has_evidence' means evidence is ABSENT. Since it HAS evidence, condition is FALSE - not marked!",
  },
  ...
  // ── History - Government & Voting ─────────────────────────────────────────
  {
    ...
    topic: "logic",
    type: "multiple-choice",
    question: "Code: 'if rulers == 1: type = \"dictatorship\" elif rulers <= 10: type = \"oligarchy\" else: type = \"democracy\"'. 5 rulers. What's the type?",
    options: ["dictatorship", "oligarchy", "democracy", "error"],
    currentAnswer: "oligarchy",
    reasoning: "5 is not 1 (not dictatorship), but IS <= 10, so it falls to oligarchy! Small group rule.",
  },
  {
    id: 181,
    topic: "algorithms",
    type: "multiple-choice",
    question: "Process ballots: group by candidate (sort), then remove where signature missing (filter). What's the combined algorithm?",
    options: ["Only sorting", "Only filtering", "Sort then filter", "Filter then sort"],
    currentAnswer: "Sort then filter",
    reasoning: "First organize votes (sorting), then remove invalid ones (filtering) - sequential operations!",
  },
  {
    id: 182,
    topic: "algorithms",
    type: "multiple-choice",
    question: "Votes: candidate_a = 150, candidate_b = 203, candidate_c = 89. Need the winner. What's the algorithm?",
    options: ["Sorting all", "Finding the maximum", "Filtering", "Looping forever"],
    currentAnswer: "Finding the maximum",
    reasoning: "Finding who has the most votes is literally finding the maximum value!",
  },
  {
    id: 183,
    topic: "logic",
    type: "multiple-choice",
    question: "Code: 'if has_signature AND marked_clearly AND not_already_voted: accept()'. Ballot has signature, is clear, but already voted. What happens?",
    options: ["Accepted", "Rejected", "Flagged for review", "Counted twice"],
    currentAnswer: "Rejected",
    reasoning: "AND requires ALL true! 'already_voted' is TRUE, so NOT makes it FALSE - one condition fails, REJECTED!",
  },
  ...
  // ── History - Events & Causes ─────────────────────────────────────────────
  {
    ...
    topic: "algorithms",
    type: "multiple-choice",
    question: "Events: [Revolution, Treaty, War, Independence]. Separate into 'causes' and 'effects'. What's the algorithm?",
    options: ["Sorting", "Categorizing/filtering", "Searching", "Counting"],
    currentAnswer: "Categorizing/filtering",
    reasoning: "Sorting events into groups based on type (cause vs effect) - that's categorization/filtering!",
  },
  {
    id: 191,
    topic: "algorithms",
    type: "multiple-choice",
    question: "Research Civil War but find events about a cooking show. Don't relate to your topic. What removes them?",
    options: ["Sorting", "Filtering out irrelevant", "Counting", "Finding maximum"],
    currentAnswer: "Filtering out irrelevant",
    reasoning: "Removing items that don't match your topic - filtering out the irrelevant ones!",
  },
  {
    id: 192,
    topic: "logic",
    type: "multiple-choice",
    question: "Code: 'if event_a.year + 1 == event_b.year AND event_a.loc == event_b.loc: link_as_sequence(a, b)'. Two events are 2 years apart. What happens?",
    options: ["They're linked", "They're NOT linked", "Error", "Random link"],
    currentAnswer: "They're NOT linked",
    reasoning: "Condition requires year difference of 1! Since they're 2 years apart, condition fails - no link!",
  },
  {
    id: 193,
    topic: "algorithms",
    type: "multiple-choice",
    question: "Track cause-effect: cause1→effect1, cause2→effect2. Best data structure to find what caused a specific effect?",
    options: ["A single variable", "A list of pairs/dictionary", "A loop only", "A print statement"],
    currentAnswer: "A list of pairs/dictionary",
    reasoning: "Storing (cause, effect) pairs lets you look up effects by cause or reverse-lookup!",
  },
];
